...
title('PD-WN');
 subplot(3,3,3)
      [C,h3]=contourf(t_axis,f_axis,f7_1');
      title('C-WN vs PD-WN');
      colormap jet
      H3=colorbar;
      caxis([-0.1 0.1]);
 ...
 line_flag=0;
  subplot(3,3,4)
       psptf_ch1a_alok_pool_comp(caseB.f,caseB.cl,freq,n_contour,colorbar_flag,line_flag,mask_flag);
title('C-WEA');
  subplot(3,3,5)
       psptf_ch1a_alok_pool_comp(caseD.f,caseD.cl,freq,n_contour,colorbar_flag,line_flag,mask_flag);
title('PD-WEA');
  subplot(3,3,6)
      [C,h6]=contourf(t_axis,f_axis,f8_1');
      title('C-WEA vs PD-WEA');
      colormap jet
      H6=colorbar;
      caxis([-0.1 0.1]);
  ...
  subplot(3,3,8)
      [C,h8]=contourf(t_axis,f_axis,f6_1');
      title('PD-WN vs PD-WEA');
      colormap jet
      H8=colorbar;
      caxis([-0.1 0.1]);
  ...
  subplot(3,3,9)
      [C,h9]=contourf(t_axis,f_axis,f9_1');
      title('C-WN vs PD-WEA');
      colormap jet
      H9=colorbar;
      caxis([-0.1 0.1]);
