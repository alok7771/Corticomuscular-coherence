function [h,hh,hhh]= psp2_tf_alok(f,t,cl,freq,lag_tot,lag_neg,t_inc,n_contour,line_flag,coh_contour)
...
colorbar_flag=1;  % No colorbars in this plot
...
subplot(3,1,1)
if (nargin>9)
  psptf_ch1a_alok(f,cl,freq,n_contour,colorbar_flag,line_flag,mask_flag,coh_contour)
else
  psptf_ch1a_alok(f,cl,freq,n_contour,colorbar_flag,line_flag,mask_flag)
end
subplot(3,1,2)
