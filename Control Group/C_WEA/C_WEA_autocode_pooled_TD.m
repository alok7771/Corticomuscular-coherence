function C_WEA_autocode_pooled_TD(EEG_ch_no,EMG_ch_no,leg)
...
fold_path='C:\Users\Alok Ranjan\Dropbox\BME coursework\2b\Internship\Data Alok\Working_directory\My codes\Control Group\C_WEA';
...
%% type and offset fields are missing from the cl struct
...
saveas(h,fullfile(sfpath,strcat('C_WEA_',pool_name,'_1','.png')));
saveas(h,fullfile(sfpath,strcat('C_WEA_',pool_name,'_1','.fig')));
saveas(hh,fullfile(sfpath,strcat('C_WEA_',pool_name,'_2','.png')));
saveas(hh,fullfile(sfpath,strcat('C_WEA_',pool_name,'_2','.fig')));
