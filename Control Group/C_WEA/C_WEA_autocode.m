function [op,pool_name,fname]=C_WEA_autocode(EEG_ch_no,EMG_ch_no,leg)
...
%%      ENTER THE FUNCTION CODE HERE
        ...
        [f,t,cl,sc,fname,pool_name]= C_WEA_EEG_EMG_solver(EEG,EMG,EEG_ch_no,EMG_ch_no,triggers,leg,k,imagedir,vfigdir,vpngdir,num);
