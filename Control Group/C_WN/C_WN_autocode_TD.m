function [op_TD,pool_name,fname]=C_WN_autocode_TD(EEG_ch_no,EMG_ch_no,leg)
...
%% This function is calling an another function "C_WN_EEG_EMG_solver_TD", which
% solves for time dependent plot. The purpose of this function is to
...
%%      ENTER THE FUNCTION CODE HERE
           ...
           [f,t,cl,sc,fname,pool_name,offset]= C_WN_EEG_EMG_solver_TD(EEG,EMG,EEG_ch_no,EMG_ch_no,triggers,leg,imagedir,vfigdir,vpngdir,num);
