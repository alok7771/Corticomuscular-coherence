function C_WN_autocode_pooled(EEG_ch_no,EMG_ch_no,leg)
% clear all;clc;
%% does the time independent pooled analysis for an already generated output
...
saveas(h,fullfile(sfpath,strcat('C_WN_',pool_name,'.png')));
saveas(h,fullfile(sfpath,strcat('C_WN_',pool_name,'.fig')));
close;
end