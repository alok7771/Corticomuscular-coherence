function [op_TD,pool_name,fname]=PD_WEA_autocode_TD(EEG_ch_no,EMG_ch_no,leg)
...
filename = 'PD_WEA_dat_EEG_EMG_2018.mat';
triggerdir = 'C:\Users\Alok Ranjan\Dropbox\BME coursework\2b\Internship\Data Alok\Working_directory\My codes\PD Group\PD_WEA\PD_WEA_trig';
...
path_dir='C:\Users\Alok Ranjan\Dropbox\BME coursework\2b\Internship\Data Alok\Working_directory\My codes\PD Group\PD_WEA';
...
%%      ENTER THE FUNCTION CODE HERE
           ...
           [f,t,cl,sc,fname,pool_name,offset]= PD_WEA_EEG_EMG_solver_TD(EEG,EMG,EEG_ch_no,EMG_ch_no,triggers,leg,imagedir,vfigdir,vpngdir,num);
