function PD_WEA_autocode_pooled_TD(EEG_ch_no,EMG_ch_no,leg)
...
saveas(h,fullfile(sfpath,strcat('PD_WEA_',pool_name,'_1','.png')));
saveas(h,fullfile(sfpath,strcat('PD_WEA_',pool_name,'_1','.fig')));
saveas(hh,fullfile(sfpath,strcat('PD_WEA_',pool_name,'_2','.png')));
saveas(hh,fullfile(sfpath,strcat('PD_WEA_',pool_name,'_2','.fig')));
close all;
end
%%