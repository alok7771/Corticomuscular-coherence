function PD_WN_autocode_pooled(EEG_ch_no,EMG_ch_no,leg)
...
saveas(h,fullfile(sfpath,strcat('PD_WN_',pool_name,'.png')));
saveas(h,fullfile(sfpath,strcat('PD_WN_',pool_name,'.fig')));
close;
end
