function [op_TD,pool_name,fname]=PD_WN_autocode_TD(EEG_ch_no,EMG_ch_no,leg)
...
filename = 'PD_WN_dat_EEG_EMG_2018.mat';
triggerdir = 'C:\Users\Alok Ranjan\Dropbox\BME coursework\2b\Internship\Data Alok\Working_directory\My codes\PD Group\PD_WN\PD_WN_trig';
...
path_dir='C:\Users\Alok Ranjan\Dropbox\BME coursework\2b\Internship\Data Alok\Working_directory\My codes\PD Group\PD_WN';
...
%%      ENTER THE FUNCTION CODE HERE
           ...
           [f,t,cl,sc,fname,pool_name,offset]= PD_WN_EEG_EMG_solver_TD(EEG,EMG,EEG_ch_no,EMG_ch_no,triggers,leg,imagedir,vfigdir,vpngdir,num);
