function PD_WN_autocode_pooled_TD(EEG_ch_no,EMG_ch_no,leg)
...
fold_path='C:\Users\Alok Ranjan\Dropbox\BME coursework\2b\Internship\Data Alok\Working_directory\My codes\PD Group\PD_WN';
...
saveas(h,fullfile(sfpath,strcat('PD_WN_',pool_name,'_1','.png')));
saveas(h,fullfile(sfpath,strcat('PD_WN_',pool_name,'_1','.fig')));
saveas(hh,fullfile(sfpath,strcat('PD_WN_',pool_name,'_2','.png')));
saveas(hh,fullfile(sfpath,strcat('PD_WN_',pool_name,'_2','.fig')));
close all;
end
%%